...
__all__ = [
    ...
    "ErrorAnalysis",
    "JSONSummarization",
    "SimplePhraseSegmenter",
    "SoloPerformanceAnalysis",
    "SoloJSONSummarization",
    "MIDIAnalyzer",
    "quick_analyze",
    "compare_performance",
    "GPTTutor",
...
package_info = {
    ...
    "modules": [
        ...
        "error_analysis",
        "json_summarization",
        "simple_phrase_segmentation",
        "solo_performance_analysis",
        "solo_json_summarization",
        "analyzer",
        "gpt_tutor",
    ],
}
...
_LAZY_EXPORTS = {
    ...
    "SimplePhraseSegmenter": (".simple_phrase_segmentation", "SimplePhraseSegmenter"),
    "SoloPerformanceAnalysis": (".solo_performance_analysis", "SoloPerformanceAnalysis"),
    "SoloJSONSummarization": (".solo_json_summarization", "SoloJSONSummarization"),
